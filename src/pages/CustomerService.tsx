...
function CustomerService() {
  return (
    <Card className="p-2 m-4 bg-orange-800">
      <section className="bg-center bg-no-repeat bg-[url('https://www.deskera.com/blog/content/images/2021/06/Blog_customercare_1500x884-1.jpg')] bg w-full bg h-full bg-gray-400 bg-blend-multiply">
